...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> showUserNameDialogAlert(BuildContext, String name){
  ...
  Future<void> showUserPhoneDialogAlert(BuildContext, String phone){
  ...
  Future<void> showUserAddressDialogAlert(BuildContext, String address){
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: () {
                      showUserNameDialogAlert(BuildContext, userModelCurrentInfo!.name!);
                    },
                        icon: Icon(
                          Icons.edit,
                        )
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: () {
                      showUserPhoneDialogAlert(BuildContext, userModelCurrentInfo!.phone!);
                    },
                        icon: Icon(
                          Icons.edit,
                        )
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: () {
                      showUserAddressDialogAlert(BuildContext, userModelCurrentInfo!.address!);
                    },
                        icon: Icon(
                          Icons.edit,
                        )
